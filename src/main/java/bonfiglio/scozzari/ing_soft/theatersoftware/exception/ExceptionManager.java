...
public class ExceptionManager {
    ...
    public ResponseEntity<ErrorMessage> handleTheaterAlreadyExistException(TheaterAlreadyExistException exception){
        ...
        LOGGER.error("TheaterAlreadyExistException: {}", exception.getMessage());

        return new ResponseEntity<>(errorMessage, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(value = {TheaterNotFoundException.class})
    public ResponseEntity<ErrorMessage> handleTheaterNotFoundException(TheaterNotFoundException exception){
        ErrorMessage errorMessage = new ErrorMessage();
        errorMessage.setTimestamp(LocalDateTime.now());
        ...
        LOGGER.error("TheaterNotFoundException: {}", exception.getMessage());
    ...
    public ResponseEntity<ErrorMessage> handleUserAlreadyExistsException(UserAlreadyExistException exception){
        ErrorMessage errorMessage = new ErrorMessage();
        errorMessage.setTimestamp(LocalDateTime.now());
        errorMessage.setStatus(HttpStatus.CONFLICT.value());
        errorMessage.setError("CONFLICT");

...
public interface AgencyService {
    ...
    void addAgency(Agency agency, Set<Long> idUser) throws AgencyAlreadyExistException, InvalidDataException, UserNotFoundException, DuplicateEmailException, DuplicatePecException, DuplicateTelException;
    ...
    List<Agency> getAllAgencies() throws DataAccessServiceException;
